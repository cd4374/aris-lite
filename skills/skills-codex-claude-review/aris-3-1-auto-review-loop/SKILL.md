...
If this is round 2+, use `mcp__claude-review__review_start-reply` with the saved review_thread_id to maintain conversation context.
...
- Save review_thread_id from first call, use `mcp__claude-review__review_start-reply` for subsequent rounds

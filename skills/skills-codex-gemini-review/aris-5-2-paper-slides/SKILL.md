...
This skill runs **after** Workflow 3 (`/aris-4-7-paper-writing`). It takes a compiled paper and generates a presentation slide deck for conference oral talks, spotlight presentations, or poster lightning talks.
...
> 💡 Override: `/aris-5-2-paper-slides "paper/" — talk_type: oral, venue: ICML, minutes: 20, aspect: 4:3`
...
Send the slide outline + selected LaTeX frames to Gemini review:
...
> ⚠️ If `mcp__gemini-review__review_start` is not available (no OpenAI API key), skip external review and proceed to Phase 6. Note the skip in `SLIDES_STATE.json`.
...
```
/aris-5-2-paper-slides "paper/" — talk_type: oral, venue: ICML, minutes: 20, aspect: 4:3, notes: false
```

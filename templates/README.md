...
|----------|-----------|---------|
| [IDEA_CANDIDATES_TEMPLATE.md](IDEA_CANDIDATES_TEMPLATE.md) | `/aris-0-2-idea-discovery` | Top 3-5 surviving ideas (lean, not full 12-idea report) |
| [EXPERIMENT_LOG_TEMPLATE.md](EXPERIMENT_LOG_TEMPLATE.md) | `/aris-0-3-experiment-bridge` | Structured experiment record (results + reproduction commands) |
| [FINDINGS_TEMPLATE.md](FINDINGS_TEMPLATE.md) | `/aris-3-1-auto-review-loop` | One-line-per-finding discovery log (anomalies, decisions) |

## Usage

```bash
cp templates/EXPERIMENT_PLAN_TEMPLATE.md 02_EXPERIMENT_PLAN.md

...
Cursor reads the full SKILL.md and follows the instructions. This is the closest equivalent to Claude Code's `/aris-3-1-auto-review-loop`.
...
2. Create a rule file, e.g. `.cursor/rules/aris-3-1-auto-review-loop.mdc`:
   ```
   ---
...
**Cursor equivalent:**
```
@skills/aris-0-2-idea-discovery/SKILL.md
...
1. @skills/aris-1-1-research-lit/SKILL.md — literature survey
2. @skills/aris-1-4-idea-creator/SKILL.md — brainstorm ideas
3. @skills/aris-1-5-novelty-check/SKILL.md — verify novelty
4. @skills/aris-1-6-research-review/SKILL.md — critical review
...
> **Important:** If using the `llm-chat` MCP instead of Codex, replace `mcp__codex__codex` with `mcp__llm-chat__chat` in your prompt. See [aris-3-4-auto-review-loop-llm](../skills/aris-3-4-auto-review-loop-llm/SKILL.md) for the adapted skill.
...
2. @skills/aris-4-2-paper-figure/SKILL.md — generate plots and tables
3. @skills/aris-4-4-paper-write/SKILL.md — write LaTeX sections
4. @skills/aris-4-5-paper-compile/SKILL.md — build PDF
5. @skills/aris-4-6-auto-paper-improvement-loop/SKILL.md — review and polish
```

### Full Pipeline

For the full pipeline (`/aris-0-1-research-pipeline`), break it into stages across chat sessions:
...
| SKILL.md files use `/skill-name` to call sub-skills | Cursor ignores these. For pipeline skills (`aris-0-2-idea-discovery`, `aris-4-7-paper-writing`), list the sub-skill `@` references explicitly in your prompt — see Workflow 1 and 3 examples |
...
```
# Literature survey
@skills/aris-1-1-research-lit/SKILL.md
...
# Single deep review
@skills/aris-1-6-research-review/SKILL.md

...
**Reviewer phase:** GPT-5.4 xhigh reviews the full paper and outputs severity-ranked issues, unsupported claims, and required fixes, with strict emphasis on: (1) rigor, (2) technical correctness, (3) content richness/depth, (4) reproducibility.

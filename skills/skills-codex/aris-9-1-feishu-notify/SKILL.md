...
| Skill | Event | When |
|-------|-------|------|
| `/aris-3-1-auto-review-loop` | `review_scored` | After each round's review score |
| `/aris-3-1-auto-review-loop` | `pipeline_done` | Loop complete (positive or max rounds) |
| `/aris-4-6-auto-paper-improvement-loop` | `review_scored` | After each round's review score |
| `/aris-4-6-auto-paper-improvement-loop` | `pipeline_done` | All rounds complete |
| `/aris-2-1-run-experiment` | `experiment_done` | Screen session finishes |
| `/aris-0-2-idea-discovery` | `checkpoint` | Between phases (if interactive) |
| `/aris-0-2-idea-discovery` | `pipeline_done` | Final report ready |
| `/aris-2-2-monitor-experiment` | `experiment_done` | Results collected |
| `/aris-0-1-research-pipeline` | `checkpoint` | Between workflow stages |
| `/aris-0-1-research-pipeline` | `pipeline_done` | Full pipeline complete |

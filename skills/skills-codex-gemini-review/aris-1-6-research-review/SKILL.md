...
- This gives Codex access to `mcp__gemini-review__review_start`, `mcp__gemini-review__review_reply_start`, and `mcp__gemini-review__review_status`.
  ...
  ```
- This gives Claude Code access to `mcp__gemini-review__review_start` and `mcp__gemini-review__review_start-reply` tools
...
Use `mcp__gemini-review__review_start-reply` with the returned `threadId` to continue the conversation:

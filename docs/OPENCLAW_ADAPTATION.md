...
|---|---|---|
| `/aris-1-1-research-lit` | 让 agent 执行文献扫描与结构化综述 | `outputs/lit_scan.md` |
| `/aris-1-4-idea-creator` | 让 agent 生成候选方案 + MVP + 失败信号 | `outputs/idea_report.md` |
| `/aris-2-1-run-experiment` | 生成实验矩阵、运行命令、日志路径规范 | `outputs/experiment_plan.md` / `outputs/runbook.md` |
| `/aris-3-1-auto-review-loop` | 轮次化评审（评分+最小修复动作） | `outputs/review_loop.md` |

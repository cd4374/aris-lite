...
- **AUTO_EXPERIMENT = false** — When `true`, invoke `/aris-0-3-experiment-bridge` for reviewer concerns that require new evidence
...
2. Invoke `/aris-0-3-experiment-bridge "rebuttal/REBUTTAL_EXPERIMENT_PLAN.md"`

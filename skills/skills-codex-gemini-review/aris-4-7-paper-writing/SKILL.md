...
> Override inline: `/aris-4-7-paper-writing "NARRATIVE_REPORT.md" — venue: NeurIPS, human checkpoint: true`
...
- Gemini reviews the plan for completeness via the `/aris-4-1-paper-plan` overlay
...
```
/aris-4-2-paper-figure "PAPER_PLAN.md"
```
...
- Gemini reviews figure quality and captions via the `/aris-4-2-paper-figure` overlay
...
If the paper plan includes architecture diagrams, pipeline figures, or method illustrations, invoke `/aris-4-3-paper-illustration`:

```
/aris-4-3-paper-illustration "[method description from PAPER_PLAN.md or NARRATIVE_REPORT.md]"
```
...
```
/aris-4-4-paper-write "PAPER_PLAN.md"
```
...
- Gemini reviews each section for quality via the `/aris-4-4-paper-write` overlay
...
/aris-4-7-paper-writing "NARRATIVE_REPORT.md"  ← Workflow 3: you are here
                                         submit! 🎉

Or use /aris-0-1-research-pipeline for the Workflow 1+2 end-to-end flow,
then /aris-4-7-paper-writing for the final writing step.
```

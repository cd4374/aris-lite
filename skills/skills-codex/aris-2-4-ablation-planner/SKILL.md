---
name: aris-2-4-ablation-planner
...
- Main results pass `/aris-3-2-result-to-claim` with `claim_supported = yes` or `partial`
- The user explicitly requests ablation planning
- `/aris-3-1-auto-review-loop` identifies missing ablations
...
- Confirmed and intended claims (from `/aris-3-2-result-to-claim` output or project notes)

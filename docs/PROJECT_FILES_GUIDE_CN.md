...
| 文件 | 创建者 | 定位 |
|------|--------|------|
| `IDEA_REPORT.md` | `/aris-1-4-idea-creator` | brainstorm 原始产出：全部 8-12 个 idea + pilot 结果 + 被 kill 的 idea |
| `refine-logs/EXPERIMENT_PLAN.md` | `/aris-1-8-experiment-plan` | 实验设计：claim 映射、实验块、执行顺序、算力预算 |
| `refine-logs/EXPERIMENT_TRACKER.md` | `/aris-1-8-experiment-plan` | 执行清单：run ID、状态（TODO→DONE）、一句话 notes |
| `AUTO_REVIEW.md` | `/aris-3-1-auto-review-loop` | 审稿循环累积日志：评分、reviewer 原始响应、采取的行动 |

...
Use this skill after the method is stable enough that the next question becomes: **what exact experiments should we run, in what order, to defend the paper?** If the user wants the full chain in one request, prefer `/aris-1-9-research-refine-pipeline`.
...
```
/aris-1-9-research-refine-pipeline -> one-shot method + experiment planning
/aris-1-7-research-refine   -> method and claim refinement

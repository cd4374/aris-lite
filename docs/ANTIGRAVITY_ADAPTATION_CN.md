...
| 阶段 | 执行方式 | 产出文件 |
|------|---------|---------|
| 1 | 创意发现：`skills/aris-0-2-idea-discovery/SKILL.md` + 研究方向 | `IDEA_REPORT.md`, `refine-logs/FINAL_PROPOSAL.md`, `refine-logs/EXPERIMENT_PLAN.md` |
| 2 | 实验桥接：`skills/aris-0-3-experiment-bridge/SKILL.md` | 实验脚本与结果 |
| 3 | 自动评审：`skills/aris-3-1-auto-review-loop/SKILL.md` | `AUTO_REVIEW.md` |
| 4 | 论文写作：`skills/aris-4-7-paper-writing/SKILL.md` + `NARRATIVE_REPORT.md` | `paper/` 目录 |
...
```
读取 skills/aris-3-1-auto-review-loop/SKILL.md，然后读取 REVIEW_STATE.json 和 AUTO_REVIEW.md。
从保存的状态恢复自动评审循环。
```
...
# 论文写作
读取 skills/aris-4-7-paper-writing/SKILL.md，根据 NARRATIVE_REPORT.md 写论文。

...
Use this reference when `aris-4-1-paper-plan` needs help shaping the paper's story or when `aris-4-4-paper-write` needs stronger drafting and revision guidance.

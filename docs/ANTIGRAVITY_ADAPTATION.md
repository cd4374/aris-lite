...
If ARIS skills are installed (§3.1), Antigravity will automatically discover and activate the `aris-3-1-auto-review-loop` skill.
...
```
Read the file skills/aris-3-1-auto-review-loop/SKILL.md and follow its instructions.
...
```
Read ~/.gemini/antigravity/skills/aris-3-1-auto-review-loop/SKILL.md and execute it.
Topic: "factorized gap in discrete diffusion LMs".
```
...
1. Read and execute skills/aris-1-1-research-lit/SKILL.md — literature survey
2. Read and execute skills/aris-1-4-idea-creator/SKILL.md — brainstorm ideas
3. Read and execute skills/aris-1-5-novelty-check/SKILL.md — verify novelty
4. Read and execute skills/aris-1-6-research-review/SKILL.md — critical review
...
**Antigravity equivalent:**
```
Read and execute skills/aris-3-1-auto-review-loop/SKILL.md.
...
> **Important:** If using the `llm-chat` MCP instead of Codex, replace `mcp__codex__codex` with `mcp__llm-chat__chat`. Or use the adapted skill: `skills/aris-3-4-auto-review-loop-llm/SKILL.md`.
...
2. Read and execute skills/aris-4-2-paper-figure/SKILL.md — generate plots and tables
3. Read and execute skills/aris-4-4-paper-write/SKILL.md — write LaTeX sections
4. Read and execute skills/aris-4-5-paper-compile/SKILL.md — build PDF
5. Read and execute skills/aris-4-6-auto-paper-improvement-loop/SKILL.md — review and polish
```

### Full Pipeline

For the full pipeline (`/aris-0-1-research-pipeline`), leverage Antigravity's **multi-agent** capability to run stages in parallel where possible:
...
- Previewing generated charts/figures from `/aris-4-2-paper-figure`
- Testing web-based arXiv searches during `/aris-1-1-research-lit`
- Viewing compiled PDF from `/aris-4-5-paper-compile`
...
- Past review findings from `/aris-3-1-auto-review-loop` are available in future sessions
...
```
# Literature survey
Read skills/aris-1-1-research-lit/SKILL.md and search for papers on "discrete diffusion models".

# Idea discovery (full pipeline)
Read skills/aris-0-2-idea-discovery/SKILL.md and run idea discovery for
"factorized gap in discrete diffusion LMs".

# Single deep review
Read skills/aris-1-6-research-review/SKILL.md and review this research:
[describe your work or point to files].

# Auto review loop
Read skills/aris-3-1-auto-review-loop/SKILL.md and run the auto review loop.
...
- [ ] Run a quick test: `Read skills/aris-1-6-research-review/SKILL.md and review my project`

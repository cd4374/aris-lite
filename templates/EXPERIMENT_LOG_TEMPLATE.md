...
>
> **How it differs from 02_EXPERIMENT_TRACKER.md:** The tracker is an execution checklist (TODO → RUNNING → DONE). This log is a permanent record with full results, configs, and reproduction commands. The tracker tells you what's left to do; the log tells you what was done and what it showed.
>

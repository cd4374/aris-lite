...
1. `aris-1-7-research-refine` for method refinement
2. `aris-1-8-experiment-plan` for claim-driven validation planning

For stage-specific detail, read these sibling skills only when needed:

- `../aris-1-7-research-refine/SKILL.md`
- `../aris-1-8-experiment-plan/SKILL.md`
...
Run the `aris-1-7-research-refine` workflow and keep its V3 philosophy intact:
...
/aris-1-7-research-refine   -> method refinement only

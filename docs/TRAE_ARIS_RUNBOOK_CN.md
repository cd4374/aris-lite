...
| 阶段 | 执行方式 | 产出文件 |
|------|---------|---------|
| 1 | 创意发现：使用 `aris-0-2-idea-discovery` 技能 + 研究方向 | `IDEA_REPORT.md`, `refine-logs/FINAL_PROPOSAL.md`, `refine-logs/EXPERIMENT_PLAN.md` |
| 2 | 实验桥接：使用 `aris-0-3-experiment-bridge` 技能 | 实验脚本与结果 |
| 3 | 自动评审：使用 `aris-3-1-auto-review-loop` 技能 | `AUTO_REVIEW.md` |
| 4 | 论文写作：使用 `aris-4-7-paper-writing` 技能 + `NARRATIVE_REPORT.md` | `paper/` 目录 |

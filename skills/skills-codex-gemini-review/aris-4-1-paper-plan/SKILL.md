...
- **TARGET_VENUE = `ICLR`** — Default venue. User can override (e.g., `/aris-4-1-paper-plan "topic" — venue: NeurIPS`). Supported: `ICLR`, `NeurIPS`, `ICML`.
...
## Next Steps
- [ ] /aris-4-2-paper-figure to generate all figures
- [ ] /aris-4-4-paper-write to draft LaTeX
- [ ] /aris-4-5-paper-compile to build PDF
```
